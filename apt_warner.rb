...
urls = ["http://sfbay.craigslist.org/search/apa/sfc?query=&srchType=A&minAsk=&maxAsk=2200&bedrooms=&addThree=wooof", "http://sfbay.craigslist.org/search/roo/sfc?query=&srchType=A&minAsk=&maxAsk=2200&bedrooms=&addThree=wooof", "http://sfbay.craigslist.org/search/sub/sfc?query=&srchType=A&minAsk=&maxAsk=2200&bedrooms=&addThree=wooof"]
...
urls.each do |url|  
 ...
 FileUtils.mkdir_p('search_counts/apartments')
  ...
  unless(File.exists? search_count_file)
    ...
    last_posting = post
    event, description = "Found new apartment", "Location: #{last_posting.location}\n#{last_posting.label} #{last_posting.price}"
